...
export function Sidebar() {
  ...
  function MobileHeader() {
    return (
      <div className="flex items-center justify-between bg-white border-b p-4 md:hidden">
        <div className="flex items-center gap-2">
          <Image src={Logo} alt="Yum X Logo" className="h-8 w-auto" />
        </div>
        <button
    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40 flex md:hidden">
          <div className="w-64 bg-white h-full shadow-lg animate-slide-in-left">
            <SidebarContent />
          </div>
...
// (Removed duplicate return and JSX)
