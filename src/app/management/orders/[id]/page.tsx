                    ...
                    <Card className="bg-white">
                        <CardContent className="p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mb-8">
                                <div className="flex">
                                    <span className="text-gray-600 font-medium w-32">Order ID:</span>
                                    <span className="text-gray-900">{orderData.orderId}</span>
                                </div>

                                <div className="flex">
                                    <span className="text-gray-600 font-medium w-32">Time of order:</span>
                                    <span className="text-gray-900">{orderData.timeOfOrder}</span>
                                </div>

                                <div className="flex">
                                    <span className="text-gray-600 font-medium w-32">Order status:</span>
                                ...
                                <div className="flex">
                                    <span className="text-gray-600 font-medium w-32">Total price:</span>
                                    <div>
                                        {orderData.itemsOrdered.map((item, index) => (
