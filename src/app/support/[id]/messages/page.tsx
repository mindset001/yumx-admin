    ...
    return (
        <div className="flex min-h-screen bg-[#FFF2F2]">
            ...
            <div className="flex-1 flex flex-col py-4 px-6">
                ...
                <div className=" px-6 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-2xl font-bold text-[#C72600]">Support</h1>
                        </div>
                ...
                {/* Chat Interface */}
                <div className="flex-1 flex flex-col bg-white rounded-lg shadow-md overflow-hidden mt-4">
                    {/* Chat Header */}
                    <div className="border-b px-6 py-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900">{chatData.user.name}</h3>
                                    <p className="text-sm text-gray-500">{chatData.user.id}</p>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col  gap-3">
                            ...
                            <div className="flex-1 relative">
                                <Input
                                    ...
                                    className="pr-24 rounded-full border-gray-300"
                                />
