                    ...
                    <Card className="bg-white">
                        <CardContent className="p-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex">
                                    <span className="text-gray-600 font-medium w-56">Order ID:</span>
                                    <span className="text-gray-900">{refundData.orderId}</span>
                                </div>

                                <div className="flex">
                                    <span className="text-gray-600 font-medium w-56">Date and time of order:</span>
                                    <div>
                                        <div className="text-gray-900">{refundData.dateAndTimeOfOrder}</div>
                                        <div className="text-gray-500 text-sm">{refundData.orderTime}</div>
                                    </div>
                                </div>

                                <div className="flex">
                                    <span className="text-gray-600 font-medium w-56">Items involved:</span>
